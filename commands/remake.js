...
cli.command("remake <file-name>", "Comment current command code and insert new one", yargs => {
	...
	const currentContent = fs.existsSync(cmdPath) ? fs.readFileSync(cmdPath).toString() : "(New file)"
